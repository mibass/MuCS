...
{  
  ...
  */
  ...
  my_tree12->Branch( "fadc", &fadc, "fadc[65]/D" );
  
  my_tree37->Branch( "fadc", &fadc, "fadc[65]/D" );
	  ...
	  */
	  ...
	  for( Int_t i=0; i<entries; i++ ) 
		...
		{ 
	      ...
	      if ( ( (tpi-tt11)*1.0e-9 )>0.5 ) gc01++;
	      
	      tt01 = tt11+gc01*1.0e+9;
	      
	      for( Int_t j=0; j<65; j++ ) { fadc[j] = 0; max_hits[j] = 0; bi_hits[j] = 0; }
	  ...
	  cout << setw(40) << " Rate in module 1 : " << setw(40) << ra1/rtime << " Hz +/- " << sqrt(ra1)/rtime << endl;
	  	  
	  cout << " " << endl; 
	  
	  cout << setw(40) << " Rate in module 2 : " << setw(40) << ra2/rtime << " Hz +/- " << sqrt(ra2)/rtime << endl;
	  	  
	  cout << " " << endl; 
	  
	  cout << setw(40) << " Rate in module 3 : " << setw(40) << ra3/rtime << " Hz +/- " << sqrt(ra3)/rtime << endl;
	  
	  cout << " " << endl; 
	  
	  cout << setw(40) << " Rate in module 7 : " << setw(40) << ra7/rtime << " Hz +/- " << sqrt(ra7)/rtime << endl; 
  ...
  cout << setw(40) << " Total rate in module 1 : " << setw(40) << tra1/ttime << " Hz +/- " << sqrt(tra1)/ttime << endl;
  
  cout << " " << endl; 
  
  cout << setw(40) << " Total rate in module 2 : " << setw(40) << tra2/ttime << " Hz +/- " << sqrt(tra2)/ttime << endl;
  
  cout << " " << endl; 
  
  cout << setw(40) << " Total rate in module 3 : " << setw(40) << tra3/ttime << " Hz +/- " << sqrt(tra3)/ttime << endl;
  
  cout << " " << endl; 
  
  cout << setw(40) << " Total rate in module 7 : " << setw(40) << tra7/ttime << " Hz +/- " << sqrt(tra7)/ttime << endl;
